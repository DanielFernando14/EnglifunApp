...
class BuahQuiz2 extends StatefulWidget {
  const BuahQuiz2({super.key});

  @override
  State<BuahQuiz2> createState() => _BuahQuiz2State();
}

class _BuahQuiz2State extends State<BuahQuiz2> {
  int userCount = 0;
