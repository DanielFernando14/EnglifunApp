...
class BentukQuiz2 extends StatefulWidget {
  const BentukQuiz2({super.key});

  @override
  State<BentukQuiz2> createState() => _BentukQuiz2State();
}

class _BentukQuiz2State extends State<BentukQuiz2> {
  int userCount = 0;
  ...
  List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'shapeList': 'Isosceles Triangle',
      'letter': 'Circle',
      'correctAnswer': 'False',
    },
    {
      'image': 'assets/images/Segitiga Sama Sisi.png',
      'shapeList': 'Equilateral Triangle',
      'letter': 'Equilateral Triangle',
      'correctAnswer': 'True',
    },
    {
      'image': 'assets/images/Segitiga Siku Siku.png',
      'shapeList': 'Right Triangle',
      'letter': 'Parallelogram',
      'correctAnswer': 'False',
    },
    {
      'image': 'assets/images/Setengah Lingkaran.png',
      'shapeList': 'Semicircle',
      'letter': 'Semicircle',
      'correctAnswer': 'True',
    },
    {
              ...
              child: Align(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Is this a shape of ${question['letter']}?',
