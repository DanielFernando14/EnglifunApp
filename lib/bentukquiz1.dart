...
class BentukQuiz1 extends StatefulWidget {
  const BentukQuiz1({super.key});

  @override
  State<BentukQuiz1> createState() => _BentukQuiz1State();
}

class _BentukQuiz1State extends State<BentukQuiz1> {
  int userCount = 0;
  ...
  List<Map<String, dynamic>> questions = [
    {
      'image': 'assets/images/Belah Ketupat.png',
      'question': 'What shape is this ?',
      'choices': ['Rhombus', 'Star', 'Heart', 'Parallelogram'],
    ...
    {
      'image': 'assets/images/Hati.png',
      'question': 'What shape is this ?',
      'choices': ['Rhombus', 'Star', 'Heart', 'Parallelogram'],
      'correctAnswer': 'Heart',
    },
    {
      'image': 'assets/images/Jajar Genjang.png',
      'question': 'What shape is this ?',
      'choices': ['Rhombus', 'Star', 'Heart', 'Parallelogram'],
      'correctAnswer': 'Parallelogram',
    },
    {
      'image': 'assets/images/Layang Layang.png',
      'question': 'What shape is this ?',
      'choices': ['Kite', 'Circle', 'Oval', 'Square'],
      'correctAnswer': 'Kite',
    },
    {
      'image': 'assets/images/Lingkaran.png',
      'question': 'What shape is this ?',
      'choices': ['Kite', 'Circle', 'Oval', 'Square'],
    ...
    {
      'image': 'assets/images/Persegi Panjang.png',
      'question': 'What shape is this ?',
      'choices': ['Rectangle', 'Octagon', 'Hexagon', 'Pentagon'],
      'correctAnswer': 'Rectangle',
    },
    {
      'image': 'assets/images/Segi Delapan.png',
      'question': 'What shape is this ?',
      'choices': ['Rectangle', 'Octagon', 'Hexagon', 'Pentagon'],
      'correctAnswer': 'Octagon',
    },
    {
      'image': 'assets/images/Segi Enam.png',
      'question': 'What shape is this ?',
      'choices': ['Rectangle', 'Octagon', 'Hexagon', 'Pentagon'],
      'correctAnswer': 'Hexagon',
    },
    {
      'image': 'assets/images/Segi Lima.png',
      'question': 'What shape is this ?',
      'choices': ['Rectangle', 'Octagon', 'Hexagon', 'Pentagon'],
      'correctAnswer': 'Pentagon',
    },
    {
      'image': 'assets/images/Segi Sembilan.png',
      'question': 'What shape is this ?',
      'choices': ['Nonagon', 'Decagon', 'Triangle', 'Isosceles Triangle'],
      'correctAnswer': 'Nonagon',
    },
    {
      'image': 'assets/images/Segi Sepuluh.png',
      'question': 'What shape is this ?',
      'choices': ['Nonagon', 'Decagon', 'Triangle', 'Isosceles Triangle'],
    ...
    {
      'image': 'assets/images/Segitiga Sama Kaki.png',
      'question': 'What shape is this ?',
      'choices': ['Nonagon', 'Decagon', 'Triangle', 'Isosceles Triangle'],
      'correctAnswer': 'Isosceles Triangle',
    },
    {
      'image': 'assets/images/Segitiga Sama Sisi.png',
      'question': 'What shape is this ?',
      'choices': [
        'Equlateral Triangle',
        'Right Triangle',
      ...
      'correctAnswer': 'Equlateral Triangle',
    },
    {
      'image': 'assets/images/Segitiga Siku Siku.png',
      'question': 'What shape is this ?',
      'choices': [
        'Equlateral Triangle',
        'Right Triangle',
    ...
    {
      'image': 'assets/images/Setengah Lingkaran.png',
      'question': 'What shape is this ?',
      'choices': [
        'Equlateral Triangle',
        'Right Triangle',
    ...
    {
      'image': 'assets/images/Trapesium.png',
      'question': 'What shape is this ?',
      'choices': [
        'Equlateral Triangle',
        'Right Triangle',
            ...
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  saveTestResult();
                  Navigator.pop(context);
                  // Navigating to Shape Quiz() is commented out since the import statement for 'Shape Quiz.dart' is missing in the code snippet.
                  // Uncomment the code below and replace 'Shape Quiz()' with the appropriate import statement.
                  // Navigator.push(
                  //   context,
                  //   MaterialPageRoute(
                  //     builder: (_) => Shape Quiz(),
                  //   ),
                  // );
                },
                child: const Text(
