...
class AlatSekolahQuiz2 extends StatefulWidget {
  const AlatSekolahQuiz2({super.key});

  @override
  State<AlatSekolahQuiz2> createState() => _AlatSekolahQuiz2State();
}

class _AlatSekolahQuiz2State extends State<AlatSekolahQuiz2> {
  int userCount = 0;
  ...
  List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'schooltoolsList': 'Backpack',
      'letter': 'Dictionary Book',
      'correctAnswer': 'False',
    },
              ...
              child: Align(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        speak("${question['schooltoolsList']}?");
                      },
