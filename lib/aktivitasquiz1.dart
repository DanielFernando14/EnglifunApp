...
class AktivitasQuiz1 extends StatefulWidget {
  const AktivitasQuiz1({super.key});

  @override
  State<AktivitasQuiz1> createState() => _AktivitasQuiz1State();
}

class _AktivitasQuiz1State extends State<AktivitasQuiz1> {
  int userCount = 0;
  ...
  List<Map<String, dynamic>> questions = [
    {
      ...
      'choices': ['Wake Up', 'Pray', 'Walk', 'Gather'],
    ...
    },
    {
      ...
      'question': 'What activity is this ?',
      'choices': ['Run', 'Shout', 'Sit', 'Go Out'],
      'correctAnswer': 'Go Out',
    },
    {
      'image': 'assets/images/Makan.png',
      'question': 'What activity is this ?',
      'choices': ['Eat', 'Take a Bath', 'Throw', 'Release'],
      'correctAnswer': 'Eat',
    },
    {
    ...
    },
    {
      ...
      'question': 'What activity is this ?',
      'choices': ['Explode', 'Jump', 'Extinguish', 'Wear'],
