...
class TempatQuiz2 extends StatefulWidget {
  const TempatQuiz2({super.key});

  @override
  State<TempatQuiz2> createState() => _TempatQuiz2State();
}

class _TempatQuiz2State extends State<TempatQuiz2> {
  int userCount = 0;
  ...
  List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'placeList': 'Chinese Temple',
      'letter': 'Chinese Temple',
      'correctAnswer': 'True',
    },
    {
      'image': 'assets/images/Kolam Renang.png',
      'placeList': 'Swimming Pool',
      'letter': 'House',
      'correctAnswer': 'False',
    },
    {
    ...
    },
    {
      ...
      'placeList': 'Supermarket',
      'letter': 'Park',
      'correctAnswer': 'False',
    },
    {
      'image': 'assets/images/Pasar Tradisional.png',
      'placeList': 'Traditional Market',
      'letter': 'Traditional Market',
      'correctAnswer': 'True',
    },
    {
      'image': 'assets/images/Pegunungan.png',
      'placeList': 'Mountains',
      'letter': 'Buddhist Temple',
      'correctAnswer': 'False',
    },
    {
  ...
  void checkAnswer(String selectedAnswer) {
    ...
    if (selectedAnswer == correctAnswer) {
      ...
      setState(() {
        correctAnswers++; // Menambah jumlah Correct Answer.
      });
    } else {
      showDialog(
        context: context,
      ...
      setState(() {
        wrongAnswers++; // Menambah jumlah Wrong Answer.
      });
    }
  }
